package
{
	    //  original from https://github.com/arthur-debert/printf-as3/blob/master/src/printf.as
		//  modified by niston
	                ...
	                if (formater == STRING_FORMATTER){
	                    ...
	                    switch (formater){
	                        ...
	                        case DATE_HOUR_AMPM_FORMATTER:
	                            match.replacement =  (replacementValue["hours"]  >= 12 ? "pm" : "am");
	                            break;
...
function padString(str:String, paddingNum:int, paddingChar:String=" ") : String
{
	...
	{
		return str.concat(new Array(paddingNum).join(paddingChar).substr(0, paddingNum-str.length));
	}	
}